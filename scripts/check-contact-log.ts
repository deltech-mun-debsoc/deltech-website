...
{
  const src = readFileSync("src/app/(admin)/admin/(event)/registrations/actions.ts", "utf8")
...
{
  const page = readFileSync("src/app/(admin)/admin/(event)/registrations/page.tsx", "utf8")
  assert.match(
    page,
