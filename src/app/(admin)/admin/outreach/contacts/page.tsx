...
import { ContactsManager } from "@/app/(admin)/admin/(event)/mailer/_components/contacts-manager"
...
export default async function ContactsPage({ searchParams }: { searchParams: Promise<{ q?: string }> }) {
  ...
  return (
    <div className="space-y-6">
      <PageHeader eyebrow="PR outreach" title="Contacts" description={`${total} on the list · ${unsubscribed} unsubscribed · ${bounced} bounced`} />
      <ContactsManager
