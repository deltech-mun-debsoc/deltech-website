...
// for a nudge missed while the connection was down.
export function SessionWatch({ committeeId }: { committeeId: string }) {
  const router = useRouter()
  useRealtime<null>(`committee:${committeeId}`, { event: "floor", onEvent: () => router.refresh() })
