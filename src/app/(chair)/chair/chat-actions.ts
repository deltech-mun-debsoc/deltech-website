...
// The dais side of committee chat. resolveCommitteeViewer is the guard: it
// answers "dais" only for a chair assigned to this committee, in the running
// event, and for nobody else, secretariat included.
...
export async function setHoldDirectMessages(
  ...
  await audit(viewer.email, on ? "committee_dm_hold_on" : "committee_dm_hold_off", "Committee", id, {})
