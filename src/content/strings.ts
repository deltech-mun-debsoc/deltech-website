...
export const STRINGS = {
  ...
  marketing: {
    ...
    gallery: {
      eyebrow: "From the last conference",
      title: "Two days, five committees, one long argument.",
      body:
        "Delegates research a country's position, defend it under pressure, and negotiate a resolution the room can live with. This is what that looks like from the floor.",
      roleCarousel: "carousel",
      roleSlide: "slide",
      slideCount: "{current} / {total}",
      goTo: "Go to photograph {current} of {total}",
      previous: "Previous photograph",
      next: "Next photograph",
      altAssembly: "The conference auditorium seen from the back, delegates at their desks facing the dais",
      capAssembly: "The floor, in full session",
      altHall: "The auditorium from the rear with the executive board seated on stage",
      capHall: "Two hundred seats, one agenda",
      altFloor: "Delegates working at the green benches of the assembly hall",
      capFloor: "Between speeches",
      altAddress: "A guest speaker addressing the conference from the lectern",
      capAddress: "The opening address",
      altRostrum: "Two students speaking from the university rostrum",
      capRostrum: "From the rostrum",
      altBoard: "The executive board seated at the head table during committee",
      capBoard: "The executive board",
      altArgument: "A delegate making a point during an unmoderated caucus",
      capArgument: "Making the point",
      altNotes: "A delegate reading her notes before taking the floor",
      capNotes: "Before the speech",
      altThinking: "A delegate thinking through a draft resolution in the committee hall",
      capThinking: "Working the draft",
      altCohort: "The whole conference gathered on stage at the closing ceremony",
      capCohort: "Everyone, at the close",
      altDelegation: "The secretariat standing outside the venue beneath the conference banners",
  ...
  admin: {
    ...
    formSync: {
      ...
      description:
        "Registrations come in through your Google Form. Connect its response sheet once, then press Refetch whenever you want the latest. Nobody is allotted or emailed here: that happens on the Allotment board.",
      sourcesTitle: "Connected response sheets",
      noSources: "No response sheet is connected yet. Connect one below.",
      lastSynced: "Last imported {when}",
      neverSynced: "Not imported yet",
      preview: "Refetch & preview",
      previewing: "Reading the sheet...",
      apply: "Import these",
      applying: "Importing...",
      previewFirst: "Press Refetch & preview first, so you can see what will change.",
      previewTitle: "What will change",
      alreadyApplied: "Nothing new: this exact sheet has already been imported.",
      countCreate: "{n} new",
      countUpdate: "{n} updated",
      countUnchanged: "{n} unchanged",
      countDuplicate: "{n} repeat submissions",
      countInvalid: "{n} can't be imported",
      attentionTitle: "Needs a look ({n})",
      attentionHelp:
        "These rows can't be imported, or can but look wrong. Fix the answer in the Google Sheet (or add the committee name under Matrix & committees), then press Refetch & preview again.",
      noAttention: "Nothing needs a look. Every row is fine.",
      duplicatesTitle: "Submitted more than once",
      duplicatesHelp: "The latest submission is kept. Tap a different one to keep that instead.",
      duplicateKept: "Kept",
      duplicateUse: "Keep this one",
      duplicateRow: "Row {row}",
      tableRow: "Row",
      tableStatus: "What happens",
      tableName: "Name",
      tableEmail: "Email",
      tableRoll: "Roll number",
      tableChoices: "Choices",
      outcomeCreate: "New",
      outcomeUpdate: "Updated",
      outcomeSkipUnchanged: "No change",
      outcomeSkipDuplicate: "Repeat",
      outcomeInvalid: "Can't import",
      protectedNote: "Kept your edits to: {fields}",
      importedResult: "Imported: {created} new, {updated} updated. {invalid} need a look.",
      importedNothing: "Nothing new to import.",
      addSource: "Connect a response sheet",
      editSource: "Change this sheet",
      labelLabel: "Name",
      labelPlaceholder: "Intra MUN 2026 responses",
      sheetUrlLabel: "Response sheet link",
      sheetUrlPlaceholder: "https://docs.google.com/spreadsheets/d/...",
      shareHint:
        "In Google Sheets press Share, then set General access to Anyone with the link, Viewer. The site only reads the sheet; it never changes it.",
      readColumns: "Read the sheet's columns",
      readingColumns: "Reading...",
      mappingTitle: "Match the columns",
      mappingHelp:
        "Each line below is matched to a column of your sheet. For the Intra MUN form this is filled in for you: just check it looks right.",
      mappingUnmapped: "Not in this sheet",
      mappingNeedsRead: "Paste the link and press Read the sheet's columns to see the choices.",
      mappingMissing: "Can't find a column for: {fields}",
      sourceIncomplete: "Needs a name, the sheet link, and the name, email and phone columns.",
      save: "Save",
      saved: "Saved. Now press Refetch & preview.",
      queriesTitle: "Questions from registrants ({n})",
      queriesEmpty: "No open questions.",
      queriesHelp: "Answered on WhatsApp or by email? Mark it answered so it leaves this list.",
  ...
  recruitment: {
    ...
    session: {
      ...
      abortTitle: "Abort this session?",
      abortDescription: "This attempt stays in the audit trail and the candidates return to the queue.",
      abortConfirm: "Abort session",
      reopen: "Reopen",
      retry: "Retry",
...
saving: "Saving…",
    ...
    selection: {
      ...
      confirmTitle: "Send selection emails?",
      confirmSend:
  ...
  docs: {
    title: "DelTech MUN Docs",
    tagline: "Guides for delegates, staff, the council and developers.",
    skipToContent: "Skip to content",
    searchLabel: "Search the docs",
    searchPlaceholder: "Search guides",
    searchEmpty: "Nothing matches that yet.",
    searchHint: "Type to search titles and topics",
    searchOpen: "Search",
    menuOpen: "Browse the docs",
    ...
    screenshotFallback: "Screenshot of the interface described above",
  },

  chair: {
    brand: "Committee dais",
    pageDescription: "You are chairing. Take roll call, run the floor, and moderate chat.",
    unassignedTitle: "You are not chairing a committee yet",
    unassignedBody:
      "The secretariat assigns chairs to committees. Once they add you, your committee appears here. You can leave this page open.",
    waitingTitle: "Waiting for the session to open",
    waitingBody:
      "The secretariat opens each session. This page moves on by itself when they do, so you can leave it open.",
    otherCommittees: "Your committees",
  },

  sessions: {
    title: "Committee sessions",
    description:
      "Open and close sessions for online committees, and choose who chairs each one. Chairs run the committee from their own page. The secretariat does not sit on the dais.",
    ...
    inSession: "In session since {time}",
    present: "{inRoom} of {total} present",
    open: "Open session",
    close: "Close session",
    confirmClose: "Close this session? Everyone is taken off the floor and out of the voice channels.",
    chairs: "Chairs",
    noChairs: "No chair yet. Add one before opening, or nobody can run the floor.",
    chairEmail: "Chair's email address",
    addChair: "Add chair",
    removeChair: "Remove",
    confirmRemove: "Remove {email} from this committee's dais? If a session is open, they are disconnected at once.",
    errorEmail: "Enter a valid email address.",
    errorNotChairAccount:
      "That address belongs to an existing {role} account. A chair needs an account of their own, so use a different address.",
    errorStale: "The session changed since this page loaded. Reload and retry.",
    errorNotFound: "That committee is not an online committee in the running event.",
    inviteFailed: "{email} was added, but the invite email failed to send. Ask them to sign in at /signin/staff with this address.",
  },

  rollCall: {
    title: "Roll call",
    description: "Mark each seat as delegates answer. Quorum is one third of the seats.",
    noSeats: "This committee has no portfolios yet, so there is nothing to call.",
    unallotted: "Unallotted seat",
    quorumMet: "Quorum met",
    quorumShort: "{n} more to reach quorum",
    inRoom: "{inRoom} of {total} present",
    markedBy: "Marked by {who}",
    statusExpected: "Not called",
    statusPresent: "Present",
    statusPresentAndVoting: "Present and voting",
    statusAbsent: "Absent",
    statusLate: "Late",
    votingNote: "Present and voting gives up the right to abstain on a substantive vote.",
  },

  committeeChat: {
    title: "Committee chat",
    pageTitle: "Your committee",
    pageDescription: "Talk to the floor, message the dais, and lobby other delegations in writing.",
    noSeat: "You do not have a seat in an online committee for the current event yet. It appears here once you are allotted.",
    openCommittee: "Open committee chat",
    chooseCommittee: "Choose a committee",
    daisLabel: "Dais",
    daisSeesAll: "The dais can read every message in this committee, including direct messages between delegations.",
    viewFloor: "Floor",
    viewDais: "Dais",
    viewDirect: "Direct",
    viewThreads: "Delegation threads",
    viewAllDirect: "All direct messages",
    viewHeld: "Waiting for approval",
    pickDelegation: "Choose a delegation",
    placeholderFloor: "Message the committee",
    placeholderDais: "Message the dais",
    placeholderDirect: "Message {name}",
    placeholderReply: "Reply to {name}",
    send: "Send",
    sending: "Sending",
    empty: "No messages here yet.",
    pickFirst: "Choose a delegation to see your conversation.",
    readOnly: "Direct messages are read here and moderated; the dais replies through delegation threads.",
    to: "to {name}",
    held: "Waiting for the dais",
    blocked: "Removed by the dais",
    approve: "Approve",
    block: "Remove",
    restore: "Restore",
    typedBy: "Typed by {email}",
    holdLabel: "Hold direct messages until the dais approves them",
    holdOn: "Direct messages wait for your approval before they are delivered.",
    holdOff: "Direct messages are delivered at once. You can still read and remove them.",
    delegateHoldOn: "Direct messages in this committee are delivered once the dais approves them.",
    counter: "{n} of {max}",
    errorEmpty: "Write something first.",
    errorTooLong: "That message is too long. Keep it under 1000 characters.",
    errorRecipient: "That delegation is not in this committee.",
    errorNotAllowed: "You cannot post here.",
    errorRateLimited: "You are sending quickly. Try again in {s} seconds.",
    errorGone: "That message no longer exists.",
    errorChanged: "Someone else changed that message a moment ago. It has been refreshed.",
    errorNetwork: "Could not reach the server. Your message was not sent.",
  },

  floor: {
    title: "Floor",
    noSession: "The floor opens when the secretariat opens the session.",
    ...
    speaking: "Speaking",
    queued: "Next up",
    emptyList: "Nobody is on this list yet.",
    addSpeaker: "Add to list",
    chooseSeat: "Choose a delegation",
    next: "Next speaker",
    pause: "Pause",
    resume: "Resume",
    end: "End",
    remove: "Remove",
    requestToSpeak: "Add me to the list",
    withdrawRequest: "Take me off the list",
    overtime: "{t} over",
    caucus: "Caucus under way",
    moderated: "Moderated caucus",
    unmoderated: "Unmoderated caucus",
    extend: "Extend",
    closeDebate: "Close debate",
    other: "Other motion",
    motions: "Motions on the floor",
    noMotions: "No motions on the floor.",
    proposeMotion: "Propose a motion",
    raiseMotion: "Raise a motion",
    motionKind: "Kind",
    topic: "Topic",
    totalMinutes: "Total minutes",
    speakingSeconds: "Seconds per speaker",
    propose: "Propose",
    withdraw: "Withdraw",
    ruleOut: "Rule out of order",
    putToVote: "Put to a vote",
    startCaucus: "Start caucus",
    endCaucus: "End caucus",
    by: "by {name}",
    stateProposed: "Proposed",
    stateVoting: "Being voted on",
    statePassed: "Passed",
    stateFailed: "Failed",
    vote: "Vote",
    noVote: "No vote is open.",
    openVote: "Open a substantive vote",
    subject: "What is being voted on",
    majoritySimple: "Simple majority",
    majorityTwoThirds: "Two-thirds majority",
    open: "Open vote",
    ...
    castCount: "{cast} of {eligible} delegations have voted",
    tallyHidden: "The count is shown when the vote closes.",
    youVoted: "You voted {choice}.",
    result: "{yes} yes, {no} no, {abstain} abstaining",
    passed: "Passed",
    failed: "Failed",
    lastResult: "Last result",
    notPresentNote: "You can vote once the dais marks you present.",
    votingNote: "You declared yourself present and voting, so you cannot abstain on this vote.",
    proceduralNote: "Procedural votes do not allow abstentions.",
    errorNoSession: "The session is not open. The secretariat opens it.",
    errorNotAllowed: "You cannot do that here.",
    errorStale: "The floor changed a moment ago. It has been refreshed; try again.",
    errorGone: "That is no longer on the floor.",
    errorSeat: "That delegation is not seated in this committee.",
    errorNoList: "That speakers list is not open.",
    errorNotQueued: "That delegation is not waiting on this list.",
    errorNotSpeaking: "Nobody is speaking there.",
    errorClock: "The clock is already in that state.",
    errorMotionState: "That motion cannot do that in its current state.",
    errorVoteOpen: "Close the open vote first.",
    errorVoteClosed: "That vote has closed.",
    errorCaucusRunning: "End the current caucus first.",
    errorAlreadyQueued: "That delegation is already on this list.",
    errorAlreadyVoted: "Your delegation has already voted.",
    errorNotPresent: "The dais has not marked your delegation present.",
    errorNoAbstainProcedural: "Procedural votes do not allow abstentions.",
