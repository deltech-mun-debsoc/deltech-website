...
export const STRINGS = {
  ...
  recruitment: {
    ...
    session: {
      ...
      confirmFinish: "Finish this session? Scores can still be revised afterwards.",
    },
    evaluation: {
      title: "Evaluation",
...
notScored: "Not scored",
    ...
    candidates: {
      ...
      bypassReasonRemaining: "{n} more characters needed. This is kept on the audit trail.",
