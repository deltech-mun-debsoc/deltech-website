...
saving: "Saving…",
  ...
  rollCall: {
    ...
    sessionClosed: "This session is closed. Open a new one to take roll again.",
    noSession: "Roll call has not been opened for this committee yet.",
    seat: "Seat",
  ...
  floor: {
    title: "Floor",
    noSession: "The floor opens when the dais opens roll call.",
    ...
    errorNoSession: "The floor is not open. The dais opens it with roll call.",
